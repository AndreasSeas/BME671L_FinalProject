function seizureTime


%% clean state
close all; clear; clc

%% load in the text of interest
directorystring = 'C:\Users\y1nzh\OneDrive\Documents\Duke Classes\BME 671\BME671L_FinalProject\RAW DATA';
cd(directorystring)

list = fopen('Seizures-list-PN00.txt');
